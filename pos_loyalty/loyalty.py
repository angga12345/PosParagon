...
class loyalty_rule(osv.osv):
    ...
    _columns = {
        ...
        'produk_pwp_ids':       fields.many2many('product.product','loyalty_rule_product_rel','rule_id','product_id',string="PWP Products ids"),
    }
    _defaults = {
        'type':'product',
    }
...
class loyalty_reward(osv.osv):
    ...
    _columns = {
        ...
        'gift_product_id':      fields.many2many('product.product',string='Gift Product', help='The product given as a reward'),
