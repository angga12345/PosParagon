...
var PosDB = core.Class.extend({
    ...
    add_order: function(order){
        ...
        console.log("ORDERRRRRRRRRRRRR LOAD _____________________________________________________=")
        console.log(order)
        ...
        console.log("order di add_order :"+order)
        
        this.save('orders',orders);
        return order_id;
    },
    update_prodvoucher: function(product){
    	console.log("PRODUCTTTTTTTTTTTTTTTT/ORDERLINES")
    	console.log(product)
    	
        var product_id = product.product_id;
        var products  = this.load('products',[]);
        console.log("PRODUCTTTTTTTTTTTTTTTT LOAD _________________________________________________======")
    	console.log(product)
    	if(product.price_unit < 0){
    		product['active']=false;
    		this.save('products',product);
    		console.log("TESSSSSSSSSSSSSSSSSSSSSSTTTTTTTTTTTTTTTT AFTER VAOUCHER")
    		console.log(product)
            return product_id;
    	}
        ...
        for (var name in product) {
        	  if (product.hasOwnProperty(name)) {
        	    console.log('this is fog (' + name + ') for sure. Value: ' + product[name]);
        	  }
        	  else {
...
//        products.push({id: product_id, data: product});
//        this.save('products',products);
        return product_id;
    },
