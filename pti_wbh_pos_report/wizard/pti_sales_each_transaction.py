...
class SalesEachTransactionWizard(models.TransientModel):
    _name = "sales.each.transaction.report.wizard"
    ...
    @api.multi
    def generate_excel_sales_ach_transaction_report(self):
        for this in self:
            ...
            return {
                ...
                'view_type': 'form',
                'view_mode': 'form',
                'res_model': 'sales.each.transaction.report.wizard',
                'res_id': this.id,
                'view_id': False,
                'views': [(form_id, 'form')],
