...
class LapPenjPerKategoriReportWizard(osv.osv_memory):
    _name = "lap.penj.per.kategori.wizard"
    ...
    def _excel_report(self, cr, uid, ids, data, context=None):
        ...
        filename = 'Laporan Penjualan Per Kategori.xlsx'
        ...
        form_res = ir_model_data.get_object_reference(cr, uid, 'pti_pos_independent_nasional_report', 'independent_nasional_store_report_lap_penj_per_kategori_wizard_view')
        ...
        return {
            ...
            'view_type': 'form',
            'view_mode': 'form',
            'res_model': 'lap.penj.per.kategori.wizard',
            'res_id': ids[0],
            'view_id': False,
            'views': [(form_id, 'form')],
