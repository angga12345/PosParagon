...
class RekapVoucherIdepStoreReportWizard(models.TransientModel):
    _name = "rekap.voucher.idep.store.wizard"
    ...
    def generate_excel_rekap_voucher(self):
        ...
        for this in self:
            ...
            filename = 'Rekap Voucher '+self.store.name+'.xls'
            ...
            bz.close()
            form_res = ir_model_data.get_object_reference('pti_pos_independent_store_report', 'independent_store_report_rekap_voucher_wizard_view')
            ...
            return {
                ...
                'view_type': 'form',
                'view_mode': 'form',
                'res_model': 'rekap.voucher.idep.store.wizard',
                'res_id': this.id,
                'view_id': False,
                'views': [(form_id, 'form')],
